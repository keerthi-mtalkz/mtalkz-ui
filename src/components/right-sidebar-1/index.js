...
const Sidebar = () => {
  ...
  let {showSectionTitle, showCard, showLogo, showAccountLinks, card} = {
    ...leftSidebar
  }
      ...
      <div>
        <div>
          ...
          <div className="flex flex-col p-4">
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-row children-x-2">
                {['ltr', 'rtl'].map((direction, i) => (
                  <button
                    key={i}
                    className={`h-10 rounded-full bg-white text-default uppercase`}
                    onClick={() => {
                      dispatch({
                        type: 'SET_CONFIG',
                        config: {
            ...
            <div className="mb-2">
              <div
                className={`uppercase text-sm font-bold font-poppins tracking-wider mb-2`}>
                Colors
              </div>
            </div>
